...
export class CampaignControllerBase {
  ...
  @common.Get("/:id/campaignApplications")
  @nestAccessControl.UseRoles({
    resource: "Campaign",
    action: "read",
    possession: "any",
  ...
  async findManyCampaignApplications(
    @common.Req() request: Request,
    @common.Param() params: CampaignWhereUniqueInput,
    @nestAccessControl.UserRoles() userRoles: string[]
  ): Promise<CampaignApplication[]> {
    const query = plainToClass(CampaignApplicationFindManyArgs, request.query);
    const permission = this.rolesBuilder.permission({
      role: userRoles,
      action: "read",
      possession: "any",
    ...
    const results = await this.service.findCampaignApplications(params.id, {
      ...query,
      select: {
        campaign: {
          select: {
  ...
  @common.Post("/:id/campaignApplications")
  @nestAccessControl.UseRoles({
    resource: "Campaign",
    action: "update",
    possession: "any",
  })
  async createCampaignApplications(
    @common.Param() params: CampaignWhereUniqueInput,
    ...
    if (invalidAttributes.length) {
      ...
      throw new common.ForbiddenException(
        `Updating the relationship: ${
          invalidAttributes[0]
        } of ${"Campaign"} is forbidden for roles: ${roles}`
      );
    }
  ...
  @common.Patch("/:id/campaignApplications")
  @nestAccessControl.UseRoles({
    resource: "Campaign",
    action: "update",
    possession: "any",
  })
  async updateCampaignApplications(
    @common.Param() params: CampaignWhereUniqueInput,
  ...
  @common.Delete("/:id/campaignApplications")
  @nestAccessControl.UseRoles({
    resource: "Campaign",
    action: "update",
    possession: "any",
  })
  async deleteCampaignApplications(
    @common.Param() params: CampaignWhereUniqueInput,
    @common.Body() body: CampaignWhereUniqueInput[],
    @nestAccessControl.UserRoles() userRoles: string[]
  ): Promise<void> {
